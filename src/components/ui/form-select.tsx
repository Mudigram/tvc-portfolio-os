    ...
    <div className="relative w-full">
      <select
        ...
        className={cn(
          ...
          'h-9 w-full appearance-none rounded-md border border-border bg-input pl-3 pr-8 text-sm text-foreground outline-none transition-colors',
          // Focus — brand colour ring via token
