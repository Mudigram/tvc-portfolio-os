...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base layout
        "flex w-full items-center justify-between gap-2 rounded-md border border-border bg-input px-3 text-sm text-foreground whitespace-nowrap outline-none transition-colors",
        // Height variants
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm text-foreground outline-none",
